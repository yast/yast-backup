...
#
module Yast
  class Ext2MountPointClient < Client
    def main
      Yast.import "UI"
      ...
      Testsuite.Test(lambda { Ext2MountPoint("/dev/hda1") }, [{}, {}, {}], nil)
      Testsuite.Test(lambda { Ext2MountPoint("/dev/hda1") }, [
        @READ_mounts,
        {},
        {}
      ], nil)
      Testsuite.Test(lambda { Ext2MountPoint("/dev/hdb1") }, [
        @READ_mounts,
        {},
        {}
      ], nil)
      Testsuite.Test(lambda { Ext2MountPoint("/dev/hdd5") }, [
        @READ_mounts,
        {},
        {}
      ], nil)
...
Yast::Ext2MountPointClient.new.main
